...
export const Camera = props => (
  <Svg width={27} height={22} {...props}>
    <G fill="none" fillRule="evenodd" stroke="#070E37">
      <Path d="M19.22 11.824a6.028 6.028 0 1 1-12.057 0 6.028 6.028 0 0 1 12.056 0z" />
      <Path d="M23.186 3.608h-5.069l-.433-1.526A2.178 2.178 0 0 0 15.59.5h-4.815c-.977 0-1.835.65-2.097 1.593l-.421 1.514H3.196A2.704 2.704 0 0 0 .5 6.304v11.794a2.704 2.704 0 0 0 2.696 2.696h19.99a2.704 2.704 0 0 0 2.696-2.696V6.304a2.704 2.704 0 0 0-2.696-2.696z" />
    </G>
  </Svg>
)