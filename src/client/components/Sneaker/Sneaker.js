...
import { requestDeleteSneaker, requestAllSneakerByModel, requestOneModel } from '../../store/reducers/sneakers/action';
...
class Sneaker extends Component {
    ...
    handleDeleteSneaker = () => {
        ...
        .then(() => { return requestAllSneakerByModel(token, currentModel) })
        .then((sneakers) => {
